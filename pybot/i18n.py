...
STRINGS = {
    "en": {
        ...
        "callsignPrompt": "8️⃣ Your callsign:\nSend your callsign as a text message (e.g. BG7WZJ).",
        "callsignUseDefault": "Use {callsign}",
        "callsignEnterNew": "Enter a different callsign",
        "callsignInvalid": "⚠️ Invalid callsign. Use 1–10 letters/digits, optionally followed by /suffix (e.g. BG7WZJ or ZL3AHW/M).",
    ...
    "ru": {
        ...
        "callsignPrompt": "8️⃣ Ваш позывной:\nОтправьте позывной текстом (напр. RA3AAA).",
        "callsignUseDefault": "Использовать {callsign}",
        "callsignEnterNew": "Ввести другой позывной",
        "callsignInvalid": "⚠️ Неверный позывной. 1–10 букв/цифр, опционально через / (напр. RA3AAA или DL/ZL3AHW).",
    ...
    "zh": {
        ...
        "callsignPrompt": "8️⃣ 你的呼号：\n请以文字消息发送你的呼号(例如 BG7WZJ)。",
        "callsignUseDefault": "使用 {callsign}",
        "callsignEnterNew": "输入其他呼号",
        "callsignInvalid": "⚠️ 呼号无效。请使用 1–10 位字母/数字，可带 /后缀(例如 BG7WZJ 或 ZL3AHW/M)。",
